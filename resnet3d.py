...
## Copy of original resnet - all 2D operations (Conv, BN, pool) are substituted with 3D counterparts
...
class ResNet(nn.Module):
    ...
    def __init__(
        ...
        self.fc1 = nn.Linear(4096+2, num_classes)
    ...
    def _forward_impl(self, x: Tensor, extra: Tensor) -> Tensor:
        ...
        x1 = extra.type(torch.FloatTensor).cuda()
